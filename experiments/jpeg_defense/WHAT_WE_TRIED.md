...
## 6. Min-distance channel (`channel_agg=min_dist`) — implemented, not fully JPEG-benchmarked
...
**Status:** In code; **no** dedicated JPEG n=50 row in your logged tables yet.
...
- **`min_dist`** full JPEG eval at n=50.
...
**Honest story for a report:** We systematically tried **detector pooling** (first / mean / median), **key strength**, and **mask radius** under **JPEG Q25**. **Channel pooling + key scaling** did not clearly improve **JPEG defense** under **strict FPR**; **radius** showed the strongest **hint** of improvement in a **small-n** ablation, with **validation pending** at n=50.
