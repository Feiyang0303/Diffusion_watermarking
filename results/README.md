...
| `jpeg_report_summary.png` | One-page figure: samples + JPEG metrics table incl. min-dist n=20 (`make_jpeg_report_figure.py`). |
| `jpeg_approaches_table.png` | **One** combined table: detectors at r=10, mean×radius, min-dist×radius (`make_jpeg_approaches_table.py`). |

**Full log of JPEG-defense experiments (mean / median / min-dist / radius / k-scale):** [`../experiments/jpeg_defense/README.md`](../experiments/jpeg_defense/README.md).
